...
set CP=%CP%;%MY_JETS3T_HOME%/jars/jets3t-0.7.1.jar
set CP=%CP%;%MY_JETS3T_HOME%/jars/jets3t-gui-0.7.1.jar
set CP=%CP%;%MY_JETS3T_HOME%/jars/cockpit-0.7.1.jar
...
"%EXEC%" -Xmx256M -classpath "%CP%" org.jets3t.apps.cockpit.Cockpit
