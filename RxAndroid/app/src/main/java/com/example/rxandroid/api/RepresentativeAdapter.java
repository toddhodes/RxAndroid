...
public class RepresentativeAdapter extends RecyclerView.Adapter<RepresentativeAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if ("D".equals(rep.party)) {
            holder.partyIcon.setImageDrawable(holder.itemView.getResources().getDrawable(R.drawable.democrat));
        } else {
            holder.partyIcon.setImageDrawable(holder.itemView.getResources().getDrawable(R.drawable.republican));
        }
    }
